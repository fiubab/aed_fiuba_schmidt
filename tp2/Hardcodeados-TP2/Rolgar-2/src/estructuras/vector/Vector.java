package src.estructuras.vector;
...
//CONSTRUCTORES -------------------------------------------------------------------------------------------
	 ...
	 * @throws RuntimeException: da error si la longitud es invalida
...
//METODOS DE COMPORTAMIENTO -------------------------------------------------------------------------------
	 ...
	 * @param dato: -
	 * @throws RuntimeException: da error si la posicion no esta en rango
	 ...
	 * @param posicion: valor entre 1 y el largo del vector
	 * @throws Exception: da error si la posicion no esta en rango
	 * post: valida la posicion que esté en rango
	 */
