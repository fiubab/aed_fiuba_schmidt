...
//CONSTRUCTORES -------------------------------------------------------------------------------------------
    ...
    public Bitmap(int width, int height) {
    	Validaciones.validarMayorQueCero(width, "ancho");
    	Validaciones.validarMayorQueCero(height, "alto");
        this.width = width;
        this.height = height;
...
//METODOS DE COMPORTAMIENTO -------------------------------------------------------------------------------
    ...
    public void drawPixel(int x, int y, Color color) {
    	Validaciones.validarRango(x, 0, getWidth(), "ancho");
    	Validaciones.validarRango(y, 0, getHeight(), "alto");
    	Validaciones.validarDistintoDeNull(color, "color");
    ...
    public void drawLine(int x1, int y1, int x2, int y2, Color color) {
    	Validaciones.validarRango(x1,0, getWidth(), "x1");
    	Validaciones.validarRango(x2, 0, getWidth(), "x2");
    	Validaciones.validarRango(y1, 0, getHeight(), "y1");
    	Validaciones.validarRango(y2, 0, getHeight(), "y2");
    	Validaciones.validarDistintoDeNull(color, "color");
    ...
    public void drawRectangle(int x, int y, int width, int height, Color color) {
    	Validaciones.validarRango(x, 0, getWidth(), "x1");
    	Validaciones.validarRango(y, 0, getHeight(), "y1");
    	Validaciones.validarRango(width, 0, getWidth(), "ancho");
    	Validaciones.validarRango(height, 0, getHeight(), "alto");
    	Validaciones.validarDistintoDeNull(color, "color");
     ...
     * @param width: mayor a cero
     * @param color
     */
    public void drawCircle(int centerX, int centerY, int width, Color color) {
        Validaciones.validarRango(centerX, 0, getWidth(), "x1");
    	Validaciones.validarRango(centerY, 0, getHeight(), "y1");
    	Validaciones.validarRango(width, 0, Math.min(getWidth(), getHeight()), "ancho");
    	Validaciones.validarDistintoDeNull(color, "color");
        int x = width;
        int y = 0;
        int err = 0;
    ...
    public void drawText(String text, int x, int y, Font font, Color color, Color background) {
    	Validaciones.validarRango(x, 0, getWidth(), "x");
    	Validaciones.validarRango(y, 0, getHeight(), "y");
    	Validaciones.validarDistintoDeNull(font, "fuente");
    	Validaciones.validarDistintoDeNull(color, "color");
